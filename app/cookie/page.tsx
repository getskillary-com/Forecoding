    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100">
      <div className="mx-auto max-w-4xl px-6 py-12 space-y-8">
        <header className="space-y-3">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">Last Updated: February 26, 2026</p>
          <p className="text-sm text-gray-600 dark:text-gray-400">Company: CIVRA LTD</p>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Registered Address: 71-75 Shelton Street, Covent Garden, London, England, WC2H 9JQ, United Kingdom
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400">ICO Registration Number: ZB949556</p>
          <p className="text-sm text-gray-600 dark:text-gray-400">
