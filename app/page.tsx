  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        <div className="absolute -top-1/2 -left-1/4 w-[800px] h-[800px] bg-purple-500/20 rounded-full blur-3xl opacity-50 animate-pulse"></div>
        <div className="absolute top-1/2 -right-1/4 w-[600px] h-[600px] bg-blue-500/20 rounded-full blur-3xl opacity-50 animate-pulse delay-1000"></div>
      </div>
      ...
      <main className="z-10 max-w-4xl w-full text-center space-y-8">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight bg-gradient-to-br from-gray-900 via-blue-800 to-purple-900 dark:from-white dark:via-blue-200 dark:to-purple-200 bg-clip-text text-transparent animate-in zoom-in-95 duration-1000">
          Turn Ideas into <br className="hidden md:block" /> Code in <span className="text-blue-600 dark:text-blue-400">Minutes</span>
        </h1>
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-5 duration-1000 delay-200">
          Forecoding guides you through a Socratic dialogue to refine your product vision, then generates a complete Next.js architecture, file tree, and Cursor prompts instantly.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8 animate-in fade-in slide-in-from-bottom-5 duration-1000 delay-300">
          ...
          <a href="#" className="flex items-center gap-2 px-8 py-4 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-xl font-semibold border border-gray-200 dark:border-gray-700 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 text-left animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-500">
          <div className="p-6 rounded-2xl bg-white/60 dark:bg-white/5 backdrop-blur-lg border border-white/20 hover:border-blue-500/50 transition-colors">
            ...
            <h3 className="text-lg font-bold mb-2">Instant Kickoff</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Skip the boilerplate setup. Get a production-ready file structure tailored to your exact needs.</p>
          </div>
          <div className="p-6 rounded-2xl bg-white/60 dark:bg-white/5 backdrop-blur-lg border border-white/20 hover:border-purple-500/50 transition-colors">
            ...
            <h3 className="text-lg font-bold mb-2">Cursor Integration</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Generates precise prompts for Cursor AI to write the implementation code for you.</p>
          </div>
          <div className="p-6 rounded-2xl bg-white/60 dark:bg-white/5 backdrop-blur-lg border border-white/20 hover:border-pink-500/50 transition-colors">
            ...
            <h3 className="text-lg font-bold mb-2">Smart Architecture</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Uses MVC-based information density scoring to ensure your spec is complete before coding.</p>
          </div>
        </div>
      </main>
    </div>
