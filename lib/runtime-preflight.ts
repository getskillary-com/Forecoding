...
export function runRuntimePreflightCheck(): RuntimePreflightResult {
    ...
    pushMissingEnvIssue(issues, "NEXT_PUBLIC_FIREBASE_API_KEY", "NEXT_PUBLIC_FIREBASE_API_KEY must be configured for browser Firebase authentication.");
    pushMissingEnvIssue(issues, "NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN", "NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN must be configured for browser Firebase authentication.");
    pushMissingEnvIssue(issues, "NEXT_PUBLIC_FIREBASE_PROJECT_ID", "NEXT_PUBLIC_FIREBASE_PROJECT_ID must be configured for browser Firebase authentication.");
    pushMissingEnvIssue(issues, "NEXT_PUBLIC_FIREBASE_APP_ID", "NEXT_PUBLIC_FIREBASE_APP_ID must be configured for browser Firebase authentication.");
    pushMissingEnvIssue(issues, "NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID", "NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID must be configured for browser Firebase authentication.");
