...
const GEMINI_MODEL = (readEnvString("GEMINI_QUESTIONER_MODEL") || readEnvString("GEMINI_MODEL", DEFAULT_GEMINI_MODEL)).trim() || DEFAULT_GEMINI_MODEL;
const GEMINI_BACKUP_MODEL = (readEnvString("GEMINI_QUESTIONER_BACKUP_MODEL") || readEnvString("GEMINI_BACKUP_MODEL", GEMINI_MODEL)).trim() || GEMINI_MODEL;
const DEFAULT_GEMINI_EXTRACTOR_MODEL = "gemini-2.5-flash-preview-05-20";
